            ...
            supporting_chunks=[
                {
                    ...
                    "chunk_no": 0,
                    "text": "GraphRAG uses graph memory and source trace.",
                    "score": 0.93,
                ...
                },
                {
                    ...
                    "chunk_no": 1,
                    "text": "A weaker chunk with partial lexical overlap.",
                    "score": 0.54,
            ...
            sources=[
                {
                    ...
                    "title": "Naive A",
                    "chunk_no": 0,
                    "snippet": "GraphRAG uses graph memory and source trace.",
                }
            ],
            confidence=0.93,
            timings={
                "strategy": "naive-rerank-v1",
            ...
            supporting_chunks=[
                {
                    ...
                    "chunk_no": 0,
                    "text": "GraphRAG connects retrieval with graph evidence.",
                    "score": 0.88,
            ...
            sources=[
                {
                    ...
                    "title": "Local Graph A",
                    "chunk_no": 0,
                    "snippet": "GraphRAG connects retrieval with graph evidence.",
                }
            ],
            confidence=0.88,
            timings={
                "strategy": "local-graph-rerank-v1",
                "candidate_count": top_k,
        ...
        return _result(
            ...
            supporting_chunks=[
                ...
                },
                {
                    ...
                    "chunk_no": 1,
                    "text": "Graph Memory stores projection state.",
                    "score": 0.71,
            ...
            entities=[
                {
                    "entity_id": "19191919-1919-1919-1919-191919191919",
                    "canonical_name": "GraphRAG",
                    "entity_type": "concept",
                    "score": 0.94,
                    "aliases": ["GraphRAG"],
                ...
                {
                    "entity_id": "20202020-2020-2020-2020-202020202020",
            ...
            relationships=[
                {
                    "relation_fact_id": "21212121-2121-2121-2121-212121212121",
                    "source_entity_id": "19191919-1919-1919-1919-191919191919",
                    "source_entity_name": "GraphRAG",
                    "target_entity_id": "20202020-2020-2020-2020-202020202020",
                    "target_entity_name": "Source Trace",
                    "relation_type": "USES",
                    "weight": 1.0,
                ...
                {
                    "relation_fact_id": "22222222-2222-2222-2222-222222222222",
                    "source_entity_id": "20202020-2020-2020-2020-202020202020",
            ...
            sources=[
                ...
                },
                {
                    ...
                    "title": "Hybrid B",
                    "chunk_no": 1,
                    "snippet": "Graph Memory stores projection state.",
                },
            ],
            confidence=0.96,
            timings={
                "strategy": "hybrid-rerank-v1",
                "candidate_count": top_k,
                "graph_limit": graph_limit,
                "rerank_applied": True,
            },
...
def _service() -> tuple[GraphRAGApplicationService, FakeRerankingRepository]:
    repository = FakeRerankingRepository()
...
def test_naive_retrieval_returns_score_breakdown_metadata() -> None:
    ...
    assert breakdown["embedding_similarity"] == 0.81
    assert breakdown["lexical_overlap"] == 0.92
    assert breakdown["entity_hit"] == 1.0
    assert breakdown["relation_hit"] == 0.0
    assert breakdown["final_score"] == 0.93
...
def test_hybrid_retrieval_limits_applied_cover_entities_relationships_and_sources() -> (
    ...
    assert limits["requested_supporting_chunks"] == 2
    assert limits["returned_supporting_chunks"] == 2
    assert limits["requested_entities"] == 2
    assert limits["returned_entities"] == 2
...
def test_hybrid_retrieval_timing_reports_operation_and_elapsed_fields() -> None:
    ...
    assert timings["strategy"] == "hybrid-rerank-v1"
